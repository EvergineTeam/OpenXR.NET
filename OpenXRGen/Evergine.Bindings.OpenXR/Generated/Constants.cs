namespace Evergine.Bindings.OpenXR
{
	public static partial class OpenXRNative
	{
		...
		public const uint XR_FB_passthrough_SPEC_VERSION = 5;
		...
		public const uint XR_KHR_extended_struct_name_lengths_SPEC_VERSION = 2;
		...
		public const uint XR_META_spatial_entity_discovery_SPEC_VERSION = 1;
		public const string XR_META_SPATIAL_ENTITY_DISCOVERY_EXTENSION_NAME = "XR_META_spatial_entity_discovery";
		...
		public const uint XR_META_body_tracking_full_body_SPEC_VERSION = 1;
		public const string XR_META_BODY_TRACKING_FULL_BODY_EXTENSION_NAME = "XR_META_body_tracking_full_body";
		...
		public const uint XR_META_body_tracking_fidelity_SPEC_VERSION = 1;
		public const string XR_META_BODY_TRACKING_FIDELITY_EXTENSION_NAME = "XR_META_body_tracking_fidelity";
		...
		public const uint XR_EXT_render_model_SPEC_VERSION = 1;
		public const string XR_EXT_RENDER_MODEL_EXTENSION_NAME = "XR_EXT_render_model";
		public const uint XR_NULL_RENDER_MODEL_ID_EXT = 0;
		public const uint XR_MAX_RENDER_MODEL_ASSET_NODE_NAME_SIZE_EXT = 64;
		public const uint XR_EXT_interaction_render_model_SPEC_VERSION = 1;
		public const string XR_EXT_INTERACTION_RENDER_MODEL_EXTENSION_NAME = "XR_EXT_interaction_render_model";
		public const uint XR_EXT_hand_interaction_SPEC_VERSION = 2;
		public const string XR_EXT_HAND_INTERACTION_EXTENSION_NAME = "XR_EXT_hand_interaction";
		public const uint XR_QCOM_tracking_optimization_settings_SPEC_VERSION = 2;
		public const string XR_QCOM_TRACKING_OPTIMIZATION_SETTINGS_EXTENSION_NAME = "XR_QCOM_tracking_optimization_settings";
		public const uint XR_QCOM_hand_tracking_gesture_SPEC_VERSION = 1;
		public const string XR_QCOM_HAND_TRACKING_GESTURE_EXTENSION_NAME = "XR_QCOM_hand_tracking_gesture";
		...
		public const uint XR_BD_future_progress_SPEC_VERSION = 1;
		public const string XR_BD_FUTURE_PROGRESS_EXTENSION_NAME = "XR_BD_future_progress";
		public const uint XR_BD_body_tracking_auxiliary_metrics_SPEC_VERSION = 1;
		...
		public const string XR_BD_SPATIAL_AUDIO_RENDERING_EXTENSION_NAME = "XR_BD_spatial_audio_rendering";
		...
		public const uint XR_ANDROID_trackables_SPEC_VERSION = 2;
		public const string XR_ANDROID_TRACKABLES_EXTENSION_NAME = "XR_ANDROID_trackables";
		public const uint XR_ANDROID_eye_tracking_SPEC_VERSION = 1;
		public const string XR_ANDROID_EYE_TRACKING_EXTENSION_NAME = "XR_ANDROID_eye_tracking";
		public const uint XR_EYE_MAX_ANDROID = 2;
		...
		public const uint XR_ANDROID_recommended_resolution_SPEC_VERSION = 1;
		public const string XR_ANDROID_RECOMMENDED_RESOLUTION_EXTENSION_NAME = "XR_ANDROID_recommended_resolution";
		public const uint XR_ANDROID_composition_layer_passthrough_mesh_SPEC_VERSION = 1;
		public const string XR_ANDROID_COMPOSITION_LAYER_PASSTHROUGH_MESH_EXTENSION_NAME = "XR_ANDROID_composition_layer_passthrough_mesh";
		...
		public const uint XR_ANDROID_performance_metrics_SPEC_VERSION = 1;
		public const string XR_ANDROID_PERFORMANCE_METRICS_EXTENSION_NAME = "XR_ANDROID_performance_metrics";
		...
		public const uint XR_ANDROID_unbounded_reference_space_SPEC_VERSION = 1;
		public const string XR_ANDROID_UNBOUNDED_REFERENCE_SPACE_EXTENSION_NAME = "XR_ANDROID_unbounded_reference_space";
		...
		public const uint XR_META_boundary_visibility_SPEC_VERSION = 1;
		public const string XR_META_BOUNDARY_VISIBILITY_EXTENSION_NAME = "XR_META_boundary_visibility";
		public const uint XR_META_simultaneous_hands_and_controllers_SPEC_VERSION = 1;
		public const string XR_META_SIMULTANEOUS_HANDS_AND_CONTROLLERS_EXTENSION_NAME = "XR_META_simultaneous_hands_and_controllers";
		public const uint XR_META_face_tracking_visemes_SPEC_VERSION = 1;
		public const string XR_META_FACE_TRACKING_VISEMES_EXTENSION_NAME = "XR_META_face_tracking_visemes";
		public const uint XR_FACE_TRACKING_VISEME_COUNT_META = 15;
		public const uint XR_META_spatial_entity_semantic_label_SPEC_VERSION = 1;
		public const string XR_META_SPATIAL_ENTITY_SEMANTIC_LABEL_EXTENSION_NAME = "XR_META_spatial_entity_semantic_label";
		public const uint XR_META_spatial_entity_room_mesh_SPEC_VERSION = 1;
		public const string XR_META_SPATIAL_ENTITY_ROOM_MESH_EXTENSION_NAME = "XR_META_spatial_entity_room_mesh";
		...
		public const uint XR_META_environment_raycast_SPEC_VERSION = 1;
		public const string XR_META_ENVIRONMENT_RAYCAST_EXTENSION_NAME = "XR_META_environment_raycast";
		public const uint XR_META_tile_properties_hint_SPEC_VERSION = 1;
		public const string XR_META_TILE_PROPERTIES_HINT_EXTENSION_NAME = "XR_META_tile_properties_hint";
		public const uint XR_META_hand_tracking_unextrapolated_poses_SPEC_VERSION = 1;
		public const string XR_META_HAND_TRACKING_UNEXTRAPOLATED_POSES_EXTENSION_NAME = "XR_META_hand_tracking_unextrapolated_poses";
		public const uint XR_META_hand_tracking_frequency_hint_SPEC_VERSION = 1;
		public const string XR_META_HAND_TRACKING_FREQUENCY_HINT_EXTENSION_NAME = "XR_META_hand_tracking_frequency_hint";
		public const uint XR_META_hand_tracking_wide_motion_mode2_SPEC_VERSION = 1;
		public const string XR_META_HAND_TRACKING_WIDE_MOTION_MODE2_EXTENSION_NAME = "XR_META_hand_tracking_wide_motion_mode2";
		public const uint XR_ANDROID_light_estimation_SPEC_VERSION = 1;
		public const string XR_ANDROID_LIGHT_ESTIMATION_EXTENSION_NAME = "XR_ANDROID_light_estimation";
		...
		public const uint XR_ANDROID_mouse_interaction_SPEC_VERSION = 1;
		public const string XR_ANDROID_MOUSE_INTERACTION_EXTENSION_NAME = "XR_ANDROID_mouse_interaction";
		...
		public const uint XR_ANDROID_trackables_qr_code_SPEC_VERSION = 1;
		public const string XR_ANDROID_TRACKABLES_QR_CODE_EXTENSION_NAME = "XR_ANDROID_trackables_qr_code";
		public const uint XR_ANDROID_trackables_image_SPEC_VERSION = 1;
		public const string XR_ANDROID_TRACKABLES_IMAGE_EXTENSION_NAME = "XR_ANDROID_trackables_image";
		...
		public const uint XR_KHR_generic_controller_SPEC_VERSION = 1;
		public const string XR_KHR_GENERIC_CONTROLLER_EXTENSION_NAME = "XR_KHR_generic_controller";
		public const uint XR_ANDROID_scene_meshing_SPEC_VERSION = 3;
		public const string XR_ANDROID_SCENE_MESHING_EXTENSION_NAME = "XR_ANDROID_scene_meshing";
		public const uint XR_EXT_spatial_entity_SPEC_VERSION = 1;
		public const string XR_EXT_SPATIAL_ENTITY_EXTENSION_NAME = "XR_EXT_spatial_entity";
		public const uint XR_EXT_spatial_plane_tracking_SPEC_VERSION = 1;
		public const string XR_EXT_SPATIAL_PLANE_TRACKING_EXTENSION_NAME = "XR_EXT_spatial_plane_tracking";
		public const uint XR_EXT_stationary_reference_space_SPEC_VERSION = 1;
		public const string XR_EXT_STATIONARY_REFERENCE_SPACE_EXTENSION_NAME = "XR_EXT_stationary_reference_space";
		public const uint XR_EXT_spatial_marker_tracking_SPEC_VERSION = 1;
		public const string XR_EXT_SPATIAL_MARKER_TRACKING_EXTENSION_NAME = "XR_EXT_spatial_marker_tracking";
		...
		public const uint XR_BD_dynamic_object_tracking_SPEC_VERSION = 1;
		public const string XR_BD_DYNAMIC_OBJECT_TRACKING_EXTENSION_NAME = "XR_BD_dynamic_object_tracking";
		public const uint XR_BD_dynamic_object_keyboard_SPEC_VERSION = 1;
		...
		public const string XR_EXT_SPATIAL_ANCHOR_EXTENSION_NAME = "XR_EXT_spatial_anchor";
		public const uint XR_EXT_spatial_persistence_SPEC_VERSION = 1;
		public const string XR_EXT_SPATIAL_PERSISTENCE_EXTENSION_NAME = "XR_EXT_spatial_persistence";
		public const uint XR_EXT_haptic_parametric_SPEC_VERSION = 1;
		...
		public const string XR_ANDROID_SPATIAL_DISCOVERY_RAYCAST_EXTENSION_NAME = "XR_ANDROID_spatial_discovery_raycast";
		public const uint XR_ANDROID_google_cloud_auth_SPEC_VERSION = 1;
		public const string XR_ANDROID_GOOGLE_CLOUD_AUTH_EXTENSION_NAME = "XR_ANDROID_google_cloud_auth";
		public const uint XR_ANDROID_geospatial_SPEC_VERSION = 1;
		public const string XR_ANDROID_GEOSPATIAL_EXTENSION_NAME = "XR_ANDROID_geospatial";
		public const uint XR_ANDROID_spatial_entity_bound_anchor_SPEC_VERSION = 2;
		public const string XR_ANDROID_SPATIAL_ENTITY_BOUND_ANCHOR_EXTENSION_NAME = "XR_ANDROID_spatial_entity_bound_anchor";
		public const uint XR_ANDROID_spatial_component_subsumed_by_SPEC_VERSION = 1;
		public const string XR_ANDROID_SPATIAL_COMPONENT_SUBSUMED_BY_EXTENSION_NAME = "XR_ANDROID_spatial_component_subsumed_by";
		public const uint XR_ANDROID_spatial_anchor_space_SPEC_VERSION = 1;
