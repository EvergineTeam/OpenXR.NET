...
namespace Evergine.Bindings.OpenXR
{
	...
	[Flags]
	public enum XrFrameSynthesisInfoFlagsEXT
	{
		None = 0,
		XR_FRAME_SYNTHESIS_INFO_USE_2D_MOTION_VECTOR_BIT_EXT = 1,
		XR_FRAME_SYNTHESIS_INFO_REQUEST_RELAXED_FRAME_INTERVAL_BIT_EXT = 2,
	}
	...
	[Flags]
	public enum XrSpaceAccelerationFlagsBD
	{
		None = 0,
		XR_SPACE_ACCELERATION_LINEAR_VALID_BIT_BD = 1,
		XR_SPACE_ACCELERATION_ANGULAR_VALID_BIT_BD = 2,
	}
	...
	[Flags]
	public enum XrPerformanceMetricsCounterFlagsANDROID
	{
		None = 0,
		XR_PERFORMANCE_METRICS_COUNTER_ANY_VALUE_VALID_BIT_ANDROID = 1,
		XR_PERFORMANCE_METRICS_COUNTER_UINT_VALUE_VALID_BIT_ANDROID = 2,
		XR_PERFORMANCE_METRICS_COUNTER_FLOAT_VALUE_VALID_BIT_ANDROID = 4,
	}
	...
	[Flags]
	public enum XrSoundObstacleFlagsBD
	{
		None = 0,
		XR_SOUND_OBSTACLE_ENABLED_BIT_BD = 1,
		XR_SOUND_OBSTACLE_POSE_BIT_BD = 2,
		XR_SOUND_OBSTACLE_MESH_BIT_BD = 4,
		XR_SOUND_OBSTACLE_MATERIALS_BIT_BD = 8,
	}

	[Flags]
	public enum XrSoundObjectFlagsBD
	{
		None = 0,
		XR_SOUND_OBJECT_ENABLED_BIT_BD = 1,
		XR_SOUND_OBJECT_POSE_BIT_BD = 2,
		XR_SOUND_OBJECT_DIRECTIVITY_BIT_BD = 4,
		XR_SOUND_OBJECT_SHAPE_BIT_BD = 8,
		XR_SOUND_OBJECT_MAIN_VOLUME_BIT_BD = 16,
		XR_SOUND_OBJECT_REFLECTION_GAIN_BIT_BD = 32,
		XR_SOUND_OBJECT_ENABLE_DOPPLER_BIT_BD = 64,
		XR_SOUND_OBJECT_DIRECT_SOUND_ATTENUATION_BIT_BD = 128,
		XR_SOUND_OBJECT_INDIRECT_SOUND_ATTENUATION_BIT_BD = 256,
	}

	[Flags]
	public enum XrSoundFieldFlagsBD
	{
		None = 0,
		XR_SOUND_FIELD_ENABLED_BIT_BD = 1,
		XR_SOUND_FIELD_ORIENTATION_BIT_BD = 2,
		XR_SOUND_FIELD_MAIN_VOLUME_BIT_BD = 4,
		XR_SOUND_FIELD_LFE_GAIN_BIT_BD = 8,
	}
	...
	[Flags]
	public enum XrSpatialMeshConfigFlagsBD
	{
		None = 0,
		XR_SPATIAL_MESH_CONFIG_SEMANTIC_BIT_BD = 1,
		XR_SPATIAL_MESH_CONFIG_ALIGN_SEMANTIC_WITH_VERTEX_BIT_BD = 2,
	}
	...
	[Flags]
	public enum XrGeospatialPoseFlagsANDROID
	{
		None = 0,
		XR_GEOSPATIAL_POSE_ORIENTATION_VALID_BIT_ANDROID = 1,
		XR_GEOSPATIAL_POSE_POSITION_VALID_BIT_ANDROID = 2,
	}
	...
	[Flags]
	public enum XrBatteryStateDisplayStateFlagsEXT
	{
		None = 0,
		XR_BATTERY_STATE_DISPLAY_STATE_VALID_BIT_EXT = 1,
		XR_BATTERY_STATE_DISPLAY_STATE_CHARGING_BIT_EXT = 2,
		XR_BATTERY_STATE_DISPLAY_STATE_PLUGGED_IN_BIT_EXT = 4,
		XR_BATTERY_STATE_DISPLAY_STATE_NO_BATTERY_BIT_EXT = 8,
	}
